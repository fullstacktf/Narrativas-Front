	...
	<div> 
        <nav class="navigationBar max-w-full h-18 lg:h-20 bg-black text-gray-600 text-lg flex items-center justify-between md:justify-around flex-row relative z-10">
            ...
            <div class="flex items-center" v-if="!isMobile">
                <button v-on:click="menuState" class="cursor-pointer"><i class="fas fa-plus pr-1 text-white"></i><i class="fas fa-sort-down text-white"></i></button>

                <div class="card alignPlusMenu flex flex-col absolute z-10 bg-white text-left lg:w-2/12 xl:w-1/12" v-if="enable">
                ...
                <button class="bg-white rounded-full w-12 h-12 ml-5" v-on:click="profileState"></button>

                <div class="card alignProfile bg-white w-1/12 absolute z-10 text-left" v-if="profile">
