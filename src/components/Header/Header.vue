	...
	<header role="header">
		...
		<div class = "invisible md:visible w-screen flex flex-row justify-center bg-black text-white pt-10 absolute z-10" v-if="enable">
			<div class="md:w-8/12 xl:w-3/12 pr-10 md:px-16 flex flex-col justify-center">
				...
				<p class="pb-4 text-gray-400 text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut sollicitudin consectetur faucibus.</p>
			</div>
			<div class="md:w-8/12 xl:w-3/12 pr-10 md:px-16 flex flex-col justify-center">
			...
			<div class = "exploreMobile w-screen h-full flex flex-col items-start bg-black text-white py-2 relative z-10 transition easy-in duration-700" v-if="mobileExploreEnable">
				<div class="w-3/4 flex flex-col pl-6">
					...
					<div class="flex justify-between">
						...
						<p class="py-4 pl-4 text-gray-400 text-xs">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut sollicitudin consectetur faucibus.</p>
					</div>
				</div>
				<div class="w-3/4 flex flex-col pl-6">
					<h3 class="py-2">Customize your character</h3>
