...
<div class="max-w-screen h-auto py-20 flex flex-col-reverse md:flex-row">
    ...
    <div class="w-full md:w-2/4 bg-gray-100 flex flex-col items-center">
        ...
        <form class="flex flex-col items-center w-10/12 xl:w-6/12">
            <input class="outline-none border border-gray-400 w-full my-2 py-2 pl-2" type="text" placeholder="Name" autocomplete="on" />
            <textarea class="outline-none border border-gray-400 w-full my-2 py-2 pl-2 h-40" cols="30" rows="10" placeholder="Description" autocomplete="on"></textarea>
        </form>
    </div>
...
export default {
    ...
    data() {
        return {
            image: require("@/assets/img/Himar.jpg"),
            blockSection: [],
        };
    },
    methods: {
        createSection() {
            ...
            blockSectionComponent.$el.classList.add(`blockSection-${store.state.blockSectionCount}`);
